# 1 "e:\\tai lieu di lam di hoc\\di lam\\Led_7doan\\sketch.ino"
# 2 "e:\\tai lieu di lam di hoc\\di lam\\Led_7doan\\sketch.ino" 2
# 3 "e:\\tai lieu di lam di hoc\\di lam\\Led_7doan\\sketch.ino" 2
...
void calculate(unsigned long number) {
  ...
  switch (length) {
    ...
    case 6:
      ...
      leds[3].display(value_led4);
      leds[4].display(value_led5);
      digitalWrite(final_led, 0x1);
      break;
  }
}
void setup() {
  pinMode(final_led, 0x1);
